...
namespace eluhr\swiper;

use eluhr\swiper\assets\SwiperAsset;
use eluhr\swiper\assets\SwiperMinAsset;
use eluhr\swiper\helpers\SwiperCssHelper;
use yii\base\Widget;
...
class Swiper extends Widget
{
     ...
     *
     * @see eluhr\swiper\Swiper::$pluginOptions
     * @return Swiper
     */
